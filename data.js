 ...
 * 生成时间: 2026-07-31 03:08
 * ============================================================
 */
const DATA = {
  "meta": {
    "lastUpdated": "2026-07-31 03:08 (官方数据, 自动更新)",
  ...
  "assets": {
    ...
    "analystView": "跨资产信号指向\"利率驱动的重定价\"而非系统性危机: 纳斯达克 (-1.22%) 与长债 (TLT -0.44%) 同步承压, 是典型的实际利率上行组合。黄金 (+1.69%) 横盘说明实际利率上行对冲了避险需求。只要 VIX (17.09) 未突破 20、信用利差未走阔, 这仍是估值压缩而非流动性事件。",
    "whatToWatch": [
      {
  ...
  "volatility": {
    "regime": {
      ...
      "signal": "mixed",
      "confidence": "中等置信",
      "description": "当前处于压力区的: OVX 原油。VIX 17.09, OVX 63.44, MOVE 77.09。分化形态决定这是单资产冲击还是系统性重定价——看压力是否从单一资产外溢。"
    },
    "keySignals": [
      {
